...
const UserLogin = () => {
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      const {data} = await axios.post('http://127.0.0.1:4000/api/v1/user/user-login',{email, password}, {
  ...
  return (
   ...
   >
     ...
     <div>
     <p>New to this portal? <Link className=' text-indigo-700 font-semibold hover:text-indigo-500' to='/user-register'>Register</Link></p>
     </div>
